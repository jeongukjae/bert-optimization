...
def get_default_bert_argument_parser():
    ...
    parser.add_argument("--model", type=str, help="pretrained bert model path")
    parser.add_argument("--config", type=str, help="bert config path")
    parser.add_argument("--output", type=str, help="output directory")
    parser.add_argument("--dataset", type=str, help="data path")
    parser.add_argument("--vocab", type=str, help="vocab path")

    parser.add_argument("--task", type=str, help="task name to train")
